...
$lang['The permalink name must be composed of a-z, A-Z, 0-9, "-", "_" or "/". It must not be numeric or start with number followed by "-"'] = 'Le lien permanent ne peut contenir que les caractères suivants : "a-z, A-Z, 0-9", "-", "_" ou "/". Il ne doit pas être uniquement numérique ou commencer par un nombre suivi par "-"';
...
$lang['Rate date'] = 'Date de la note';
...
$lang['Site manager'] = 'Gestionnaire de sites';
$lang['Status'] = "Statut";
...
$lang['No user to send notifications by mail.'] = 'Pas d\'utilisateur pour envoyer des notifications par mail.';
...
$lang['randomly represented'] = 'Miniature d\'album choisie au hasard';
...
$lang['singly represented'] = 'Miniature d\'album fixe';
...
$lang['all'] = "Tout";
$lang['height must be a number superior to'] = 'la hauteur doit être un entier supérieur à';
...
$lang['reduce to single existing albums'] = 'Traiter un album spécifique';
...
$lang['The file or directory cannot be accessed (either it does not exist or the access is denied)'] = 'Le fichier ou répertoire n\'est pas accessible (soit il n\'existe pas, soit l\'accès est refusé)';
...
$lang['synchronize files metadata with database photos informations'] = 'Synchroniser les informations des photos dans la base de données à partir des méta-données des fichiers';
...
$lang['Are you sure to install this upgrade? You must verify if this version does not need uninstallation.'] = 'Êtes-vous sur de vouloir installer cette mise à jour ? Vous devez vérifier que cette mise à jour ne nécessite pas de désinstallation préalable.';
...
$lang['Replacement of original templates by customized templates from template-extension subfolder'] = 'Remplacement des templates d\'origine par vos templates personnalisés issus du sous dossier template-extension';
...
$lang['Impossible to delete this theme. Other themes depends on it: %s'] = 'Ce thème ne peut être supprimé, car d\'autres thèmes dépendent de lui : %s';
...
$lang['Failed to write file to disk'] = 'Échec de l\'écriture du fichier sur le serveur';
...
$lang['simple visitors'] = 'simples visiteurs';
...
$lang['iPhoto is the default photo manager on MacOSX. The Piwigo export plugin let you create new albums and export your photos directly from iPhoto to your Piwigo photo gallery.'] = 'iPhoto est le gestionnaire de photos disponible par défaut sur MacOSX. Le plugin d\'export Piwigo se connecte à votre galerie Piwigo et vous permet de créer des albums et d\'y ajouter vos photos.';
...
$lang['Global sharpening'] = 'Netteté globale';
$lang['Apply the same sharpening to all derivative sizes'] = 'Appliquer la même netteté à toutes les tailles de dérivés';
...
$lang['This group will be set to default'] = 'Ce groupe sera utilisé par défaut';
$lang['This group will be unset to default'] = 'Ce groupe ne sera plus utilisé par défaut';
...
$lang['The settings for the guest are from the %s user'] = 'Les préférences des invités sont celles de l\'utilisateur %s';
...
$lang['Choose which tag to merge these tags into'] = 'Choisissez dans quel tag vont être fusionnés les tags';
...
$lang['Are you sure you want to delete this?'] = 'Êtes-vous sûr de vouloir supprimer cela&nbsp; ?';
...
$lang['Photos per page'] = 'Photos par page';
$lang['Users not logged in will have these settings applied, these settings are used by default for new users'] = 'Les paramètres définis ici sont appliqués aux visiteurs anonymes (non connectés) de votre galerie ; ils sont également appliqués par défaut lorsque vous créez un nouvel utilisateur.';
...
$lang['Are you sure you want to delete group "%s"?'] = 'Êtes-vous sûr de vouloir supprimer le groupe "%s"&nbsp;?';
...
$lang['Group(s) \{%s1\} succesfully merged into "%s2"'] = 'Le(s) groupe(s) \{%s1\} a / ont été fusionné(s) dans le groupe "%s2"';
...
$lang['Select an album... or type it!'] = 'Sélectionnez un album... ou saisissez-le !';
...
$lang['%s line'] = "%s ligne";
$lang['Locked albums are disabled for maintenance. Only administrators can view them in the gallery. Lock this album will also lock his Sub-albums'] = 'Les albums vérrouillés sont désactivés pour maintenance. Seuls les administrateurs peuvent les voir dans la galerie. Verrouiller cet album verrouillera aussi ses sous-albums';
...
$lang['Apply to root albums'] = 'Appliquer aux albums racines';
